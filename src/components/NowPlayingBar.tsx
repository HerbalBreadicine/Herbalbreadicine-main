...
const NowPlayingBar: React.FC = () => {
  return (
    <div className="h-20 bg-black border-t border-yellow-400/30 text-white p-4 flex items-center justify-between">
      <div className="flex items-center space-x-4">
        <div className="w-12 h-12 bg-black border border-yellow-400 rounded flex-shrink-0 flex items-center justify-center">
        ...
        <div>
          <div className="font-medium text-yellow-400">Ghost Riders in the Sky</div>
      ...
      <div className="flex flex-col items-center space-y-2">
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-yellow-400 text-black rounded-full w-8 h-8 flex items-center justify-center hover:bg-yellow-300">
